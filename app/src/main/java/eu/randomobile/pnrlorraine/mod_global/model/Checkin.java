...
public class Checkin {
    ...
    public interface CheckinInterface {
        void seCargoListaCheckins(ArrayList<Checkin> checkins);

        void producidoErrorAlCargarListaCheckins(String error);

        void seCargoCheckin(Checkin checkin);

        void producidoErrorAlCargarCheckin(String error);

        void seHaRealizadoCheckin(boolean res, String nidCheckin);

        void producidoErrorAlRealizarCheckin(String strError, int errorCode);
    }
