...
public class Enigma {
    ...
    public interface EnigmasInterface {
        void seCargoEnigma(Enigma enigma);

        void producidoErrorAlCargarEnigma(String error);

        void seHaResueltoEnigma(boolean res);

        void producidoErrorAlResolverEnigma(String error);
    }
